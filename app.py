...
from japanmap import pref_map, pref_code
import pandas as pd
import random
...
data = {
    ...
    "region": ["北海道", "東北", "東北", "東北", "東北", "東北", "東北", "関東", "関東", "関東", "関東", "関東", "関東", "関東", "中部", "中部", "中部", "中部", "中部", "中部", "中部", "中部", "中部", "近畿", "近畿", "近畿", "近畿", "近畿", "近畿", "近畿", "中国", "中国", "中国", "中国", "中国", "四国", "四_国", "四国", "四国", "九州", "九州", "九州", "九州", "九州", "九州", "九州", "九州"],
...
if level == "Lv1: 地方":
    ...
    color_dict = {pref_code(name): "orange" for name in region_prefs}
else:
    color_dict = {pref_code(target['name']): "red"}
